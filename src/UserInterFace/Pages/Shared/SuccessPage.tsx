...
import successIllust from "../../Images/bookingsuccessmodal.webp";
...
export default function SuccessPage() {
  ...
  const displayTitle = titleKey ? t(titleKey) : (title || t('messages.DEFAULT_SUCCESS_TITLE'));
  const displayMessage = messageKey ? t(messageKey) : (message || t('messages.DEFAULT_SUCCESS_MESSAGE'));
  const displayButtonText = buttonTextKey ? t(buttonTextKey) : (buttonText || t('messages.BACK_TO_HOME'));
