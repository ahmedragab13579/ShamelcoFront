...
export type AppMessageCodes =
  ...
  | 'GOVERNORATE_ADDED_SUCCESSFULLY'
  | 'NOTIFICATION_CREATED_SUCCESSFULLY'
  | 'PAYMOB_TOKEN_RETRIEVED_SUCCESSFULLY'
  | 'PAYMOB_ORDER_REGISTERED_SUCCESSFULLY'
  | 'PAYMOB_PAYMENT_KEY_GENERATED_SUCCESSFULLY'
  | 'PLACES_RETRIEVED_SUCCESSFULLY'
  | 'RESOURCE_RETRIEVED_SUCCESSFULLY'
  | 'RESOURCE_CREATED_SUCCESSFULLY'
  | 'CONSOLE_UPDATED_SUCCESSFULLY'
